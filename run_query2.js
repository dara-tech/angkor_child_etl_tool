...
async function run() {
    ...
    if (r.recordset.length > 0) {
        ...
        fs.writeFileSync('C:\\Users\\Dell\\.gemini\\antigravity-ide\\brain\\f8035620-2447-43b7-bf98-fd07edad0772\\scratch\\output_fixed.csv', headers + '\\n' + rows.join('\\n'));
        console.log('Wrote output_fixed.csv');
    }
